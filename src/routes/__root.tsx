...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Ummeed- You matter here. A confidential space to speak up" },
      ...
      { name: "twitter:description", content: "If you’re going through something, you’re not alone. Seth M.R. Jaipuria School, Digital Campaign Club, brings you a safe, confidential place to report bullying." },
